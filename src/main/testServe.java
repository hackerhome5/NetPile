...
public class testServe {
	...
	public static void main(String[] args) throws Exception {
		...
		//Serial o = new Serial();
		//o.encryptTemp("davidsmerkous123", "javapapers", "C:\\Users\\David\\Desktop\\NetPile.class");
		//FileWriter file = new FileWriter(new File("C:\\Users\\David\\Desktop\\NetPile2.class"));
