...
public class Serial {
	...
	public static void init() throws SerialException {
		try {
	...
	public static String encryptTemp(String username, String password, String fileDir) throws IOException {
	...
	public static String decryptTemp(String username, String password) throws IOException {
		return decryptTemp(username, password, null);
	}

	public static String decryptTemp(String username, String password, String toTemps) throws IOException {
		String full;
		if (toTemps == null) {
			BufferedReader read = new BufferedReader(new FileReader(temp));
			StringBuilder files = new StringBuilder();
...
class Encrypt {
	...
	public static String encrypter(String key, String vector, String value) {
		try {
	...
	public static void FileEncrypter(String password, File inputFile, String path) throws Exception {
		...
		KeySpec keySpec = new PBEKeySpec("javapapers".toCharArray(), salt, 65536, 256);
	...
	public static String decrypter(String key, String vector, String value) {
		try {
			IvParameterSpec iv = new IvParameterSpec(vector.getBytes("UTF-8"));
			SecretKeySpec skeySpec = new SecretKeySpec(key.getBytes("UTF-8"), "AES");
			Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5PADDING");
